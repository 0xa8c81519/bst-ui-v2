...
export class BootService {
	...
	private initContracts(): Promise<any> {
		...
		return this.paymentContract.token().then(add => {
			...
			let coins = new Array();
			coins.push(this.chainConfig.contracts.usdc.address);
			coins.push(this.chainConfig.contracts.busd.address);
			coins.push(this.chainConfig.contracts.usdt.address);
